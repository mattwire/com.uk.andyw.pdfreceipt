...
class CRM_Contribute_Receipt_ChamberlainDunn extends CRM_Contribute_Receipt {
    ...
    public function printBody() {
        ...
        foreach ($lineItems as $lineItem) {
            ...
            $pdf->MultiCell($col_widths['vat'], $row_height, self::vat_rate . "%", 'R', 'C', false, 0);
        ...
        if (isset($this->contact['primary']['display_name']))
            $item_details = "Attendee: " . $this->contact['primary']['display_name'];
        ...
        $payee_info = "Please make cheques payable to Chamberlain Dunn or arrange BACS transfer with the details below:\n" . 
                      "Sterling Payments S/C: 60-40-02 A/C: 58808183 Bank: NatWest, Quote: HRM13\n" . 
                      "Cheques should be sent to Chamberlain Dunn, The Old Candlemakers, West Street, Lewes, BN7 2NZ";
        ...
        $pdf->SetFont('sourcesansprosemib', '', 8, true);
        $pdf->MultiCell(80, $row_height, ts('Please note as per our terms and conditions payment must be made before the event and must include VAT, or you will incur a £50+VAT administration charge.'), 'LRB', 'C', false, 1);
    ...
    public function printBodyBottom() {
        ...
        $pdf->SetXY($pdf->marginLeft, $pdf->GetY() + 8.5);
        $pdf->SetFont('sourcesansprosemib', '', 7.5, true);

        $pdf->SetFillColor(200, 200, 200);
        $pdf->MultiCell(177.5, 0, 
            "Please make cheques payable to Chamberlain Dunn or arrange your BACS transfer with the following details:\n" . 
            "Sterling Payments S/C: 60-40-02 A/C: 58808183 Bank: NatWest, Quote: HRM13\n" . 
            "Cheques should be sent to Chamberlain Dunn, The Old Candlemakers, West Street, Lewes, BN7 2NZ", 
            'LTRB', 'C', true, 1
        );
    ...
    public function printHeaderTop() {
        ...
        $pdf->SetFont('sourcesanspro', '', 8, true);
        $pdf->SetXY($pdf->marginLeft, $this->marginTop + 42);        
        $pdf->MultiCell(0, 0, "The Old Candlemakers, West Street, Lewes BN7 2NZ\nT: 0208 33 44 500 F: 0208 33 27 201 E: mail@chamberdunn.co.uk", $this->border, 'C'); 
