...
class CRM_Contribute_Receipt_SOM extends CRM_Contribute_Receipt {
    ...
    public function printLogo() {
        ...
        $this->pdf->Image(
            '/var/www/html/drupal/sites/som.org.uk/files/som-logo-rt.jpg', # file
            0,                          # x
            0,          # y
            110,                           # w
            '',                            # h
        ...
        watchdog("sam", print_r($this, true));
