...
/**
 * Class to generate pdf receipts in custom formats
 * based on CRM/Utils/PDF/Label.php
 * andyw@circle, 22/09/2012
 */

require_once CRM_Core_Config::singleton()->extensionsDir . DIRECTORY_SEPARATOR . 
             'com.uk.andyw.pdfreceipt' . DIRECTORY_SEPARATOR . 
             'tcpdf' . DIRECTORY_SEPARATOR . 'tcpdf.php';

class CRM_Utils_PDF_Receipt extends TCPDF {
    ...
    function setGenerator($objectinstance, $methodname='generateReceipt') {
